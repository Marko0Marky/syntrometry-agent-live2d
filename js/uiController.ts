...
/**
 * UI Controller module for managing UI state and interactions
 */

// Import types (Corrected extension)
import { UIMode } from './appTypes.js'; // Assuming appTypes.ts exports UIMode
...
export function getUIMode(): UIMode {
  ...
  const mode = document.body.dataset.uiMode as UIMode || "normal";
  return mode;
}
 ...
 */
export function toggleUIMode(mode1: UIMode, mode2: UIMode): UIMode {
